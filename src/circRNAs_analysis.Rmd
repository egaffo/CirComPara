  ...
  if(!stranded.lib){
      ...
      circrnas.gtf <- 
          circrnas.gtf[, .(V6 = sum(V6)), 
                       by = .(V1, V2, V3, V4, V5, V7, V8, sample_id, gene_id, transcript_id)]
  }
...
circrnas.morethan2methods.medrpm <- 
    unique(circrna.rpms.genes[circrnas.morethan2methods][median.reads > 0, 
                                                  .(circ_id, gene_ids, gene_names, 
                                                    label, sample_id, chr = V1, 
                                                    start = V4, end = V5, 
                                                    strand = V7, median.reads)])
