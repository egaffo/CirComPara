...
if __name__ == '__main__':
    ...
    usage = """
           Extract backspliced reads, according to CIRCexplorer2 parse, from SAM file generated by BWA, and output into BED coordinates. Output in stdout.
            """

    parser = argparse.ArgumentParser(description = usage, 
                                     formatter_class = argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('-i', '--infilename', default = '-', required = True,
                        help = 'bwa_out/RS4_11_bwa.sam')
